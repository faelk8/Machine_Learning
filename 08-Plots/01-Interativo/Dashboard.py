...
# ajuste os gráficos por padrão 
st.set_page_config(layout= 'wide')

def formata_numero(valor, prefixo = ''):
    """
    Forta o número em Milhôes

    Input : 
        valor: float
        prefixo: formato dos dados R$
    Output: 
        string: formatada R$ #.### Milhão
    """
    for unidade in ['', 'mil']:
        if valor <1000:
...
# Filtros - ajusta a url para trazer os dados filtrados
regioes = ['Brasil', 'Centro-Oeste', 'Nordeste', 'Norte', 'Sudeste', 'Sul']
# Titulo da barra lateral
st.sidebar.title('Filtros')
regiao = st.sidebar.selectbox('Região', regioes)
# Como só tem Brasil não faz nenhuma filtragem
if regiao == 'Brasil':
    regiao = ''
...
if todos_anos:
    ...
    ano = st.sidebar.slider('Ano', 2020, 2023) # valor minimo e maximo
query_string = {'regiao':regiao.lower(), 'ano':ano}

# Pegando os dados da url
response = requests.get(url, params= query_string)
# Converte para json e transforma em um dataframe
...
with aba1:
    ...
    with coluna1:
        ...
        st.plotly_chart(fig_mapa_receita, use_container_width= True) # use_container_width= True ajusta o gráfico 
...
with aba3:
    qtd_vendedores = st.number_input('Quantidade de vendedores', 2, 10, 5) # minimo de 2 vendedores, maximo de 10, padrão 5 
    coluna1, coluna2 = st.columns(2)
    with coluna1:
        st.metric('Receita', formata_numero(dados['Preço'].sum(), 'R$'))
